...
// http://localhost:8085/001_RESTfulJersey/rest/kullanici
@Path(value="/kullanici")
public class Merkez {


	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/karisla1	
	@GET
	@Path(value="karisla1")
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/karisla2	
	@GET
	@Path(value="karisla2")
	@Produces(MediaType.TEXT_PLAIN)
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/selamla/Melek	
	@GET
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/selamla/Burak/Umut	
	@GET
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/selamla-html/BURAK
	@GET
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/selamla7/ğüİşö/çÖıĞÜ
	@GET
	...
	// http://localhost:8085/001_RESTfulJersey/rest/kullanici/selamla-xml/BURAK	
	@GET
